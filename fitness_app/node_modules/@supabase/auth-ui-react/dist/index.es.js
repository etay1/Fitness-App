import { css as H, createStitches as o1, createTheme as s1 } from "@stitches/core";
...
function X({
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: x }, /* @__PURE__ */ e.createElement(N, { gap: "large", direction: "vertical", appearance: n }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: n }, i == null ? void 0 : i.email_input_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "email",
      name: "email",
  ...
  ), a && /* @__PURE__ */ e.createElement(F, { appearance: n }, a), C && /* @__PURE__ */ e.createElement(F, { color: "danger", appearance: n }, C)));
}
const L = H({
  width: "21px",
  height: "21px"
...
function A1({
  ...
  providers: o = ["github", "google", "azure"],
  providerScopes: r,
  queryParams: n,
  redirectTo: v,
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, o && o.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(N, { gap: "large", direction: "vertical", appearance: d }, /* @__PURE__ */ e.createElement(
    N,
    {
...
function Q({
  ...
  var T, G, Z, j;
  const x = m1(!0), [i, _] = u(l), [h, g] = u(o), [s, k] = u(""), [p, B] = u(!1), [P, A] = u("");
  R(() => (x.current = !0, _(l), g(o), () => {
    x.current = !1;
  }), [t]);
  const O = async (M) => {
    var q;
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(N, { direction: "vertical", gap: "large", appearance: c }, /* @__PURE__ */ e.createElement(N, { direction: "vertical", gap: "large", appearance: c }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: c }, f == null ? void 0 : f.email_label), /* @__PURE__ */ e.createElement(
      D,
      {
        id: "email",
        type: "email",
    ...
    ), w && /* @__PURE__ */ e.createElement(N, { direction: "vertical", gap: "small", appearance: c }, t === b.SIGN_IN && a && /* @__PURE__ */ e.createElement(
      V,
      {
...
function e1({
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-forgot-password", onSubmit: x }, /* @__PURE__ */ e.createElement(N, { direction: "vertical", gap: "large", appearance: n }, /* @__PURE__ */ e.createElement(N, { gap: "large", direction: "vertical", appearance: n }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "email", appearance: n }, i == null ? void 0 : i.email_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "email",
      name: "email",
...
function t1({
  ...
  const [r, n] = u(""), [v, E] = u(""), [w, C] = u(""), [d, a] = u(!1), m = async (y) => {
    var i;
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-update-password", onSubmit: m }, /* @__PURE__ */ e.createElement(N, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "password", appearance: o }, c == null ? void 0 : c.password_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "password",
      name: "password",
  ...
  ), w && /* @__PURE__ */ e.createElement(F, { appearance: o }, w), v && /* @__PURE__ */ e.createElement(F, { color: "danger", appearance: o }, v)));
}
function U1({
  setAuthView: t = () => {
  },
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: g }, /* @__PURE__ */ e.createElement(N, { gap: "large", direction: "vertical", appearance: n }, ["sms", "phone_change"].includes(o) ? /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement($, { htmlFor: "phone", appearance: n }, s == null ? void 0 : s.phone_input_label), /* @__PURE__ */ e.createElement(
    D,
    {
      id: "phone",
      name: "phone",
    ...
    (k = r == null ? void 0 : r.sign_in) == null ? void 0 : k.link_text
  ), x && /* @__PURE__ */ e.createElement(F, { appearance: n }, x), c && /* @__PURE__ */ e.createElement(F, { color: "danger", appearance: n }, c)));
}
const l1 = d1({ user: null, session: null }), R1 = (t) => {
  const { supabaseClient: l } = t, [o, r] = u(null), [n, v] = u((o == null ? void 0 : o.user) ?? null);
  R(() => {
    (async () => {
      var d;
...
function S({
  ...
  const _ = W(i1, c.variables ?? {}), [h, g] = u(v), [s, k] = u(""), [p, B] = u(""), P = h === "sign_in" || h === "sign_up" || h === "magic_link";
  R(() => {
    var z, f;
    o1({
      theme: W(
        ((z = a == null ? void 0 : a.theme) == null ? void 0 : z.default) ?? {},
...
const W1 = H({
  ...
  return /* @__PURE__ */ e.createElement("div", { className: o.join(" ") }, t);
